...
public class PoolSupplierTest extends AbstractTest {
  private ExpirableCoordinatorSupplier supplier;
  ...
  private void doTest() throws Exception {
    ...
    Assertions.assertEquals(1000875, pool01.getPremixValue());
    ...
    Assertions.assertEquals(1051139, tx0Preview.getTotalValue());
    Assertions.assertEquals(1051139, tx0Preview.getSpendValue());
    ...
    Assertions.assertEquals(875, tx0Preview.getMixMinerFee());
    ...
    Assertions.assertEquals(1051139, pool01.getTx0PreviewMinSpendValue());
  }
}
