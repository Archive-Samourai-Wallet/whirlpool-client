...
public class WhirlpoolWalletTx0Test extends Tx0ServiceV1Test {
  ...
  /* Tx0 Cascade using tx0Cascade()
   * Uses Tx0Previews()
   * Checks if change is large enough with if(NbPremix > 0 && ChangeValue >= 0)
   * Tests tx0Cascascade_test0 - tx0Cascade_test4
   * Probably going to use these
   */
  @Test
  ...
  public void tx0Cascade_test1() throws Exception {
    ...
    int totalNbPremix = tx0_pool05.getNbPremix() + tx0_pool01.getNbPremix() + tx0_pool001.getNbPremix();
   ...
   * Tests tx0Cascascade_v1_test0 - tx0Cascade_v1_test4
   * Probably going to delete these
   */
  @Test
  public void tx0Cascade_v1_test0() throws Exception {
    log.info("Testing 0.05432999 btc. Makes Tx0s for pools 0.05 & 0.001");
    ...
    // run
    List<Tx0> tx0s = whirlpoolWallet.tx0Cascade_v1(Arrays.asList(spendFromUtxo), tx0Config, pool);
  ...
  @Test
  public void tx0Cascade_v1_test1() throws Exception {
    log.info("Testing 0.06432999 btc. Makes Tx0s for pools 0.05, 0.01, & 0.001");
  ...
  @Test
  public void tx0Cascade_v1_test2() throws Exception {
    log.info("Testing 0.74329991 btc. Makes Tx0s for pools 0.5, 0.05, 0.01, & 0.001");
  ...
  @Test
  public void tx0Cascade_v1_test3() throws Exception {
    log.info("Testing 0.52329991 btc. Makes Tx0s for pools 0.5 & 0.001");
  ...
  @Test
  public void tx0Cascade_v1_test4() throws Exception {
    log.info("Testing 0.02329991 btc. Makes Tx0s for pools 0.01 & 0.001");
